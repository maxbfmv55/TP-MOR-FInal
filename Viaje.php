	...
	*/
    ...
    public function insertar()
    {
		...
		$consultaInsertar="INSERT INTO viaje(vdestino, vcantmaxpasajeros, idempresa, rnumeroempleado, vimporte) 
				VALUES ('{$this->getVdestino()}',{$this->getVcantmaxpasajeros()},$idempresa,$numEmpleado,{$this ->getVimporte()})";
    ...
    { 
        ...
        $responsable = $this->getObjResponsable();
        $numEmpleado = $responsable->getRnumeroempleado();
		$consultaModifica="UPDATE viaje SET vdestino='{$this->getVdestino()}',vcantmaxpasajeros={$this->getVcantmaxpasajeros()} ,idempresa=$idempresa,rnumeroempleado=$numEmpleado,vimporte={$this->getVimporte()} WHERE idviaje={$this->getIdviaje()}";
